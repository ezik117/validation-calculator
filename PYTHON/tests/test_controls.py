# *****************************************************************************
# МОДУЛЬ:    test_controls
# ФАЙЛ:      test_controls.py
# ЗАГОЛОВОК: КЛАСС тестов для функций контроля
# ОПИСАНИЕ:  Класс служит для тестирования через pytest функций контроля класса Flags
# *****************************************************************************
